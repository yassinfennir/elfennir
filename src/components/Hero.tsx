        ...
        >
          <motion.div
            className={`relative rounded-full flex items-center justify-center ${
              node.isCenter
                ? "bg-gradient-to-br from-[#9945ff]/20 to-[#00d1ff]/10 border-2 border-[#9945ff]/40 shadow-[0_0_30px_rgba(153,69,255,0.2)]"
                : "bg-[#0c0c14] border border-white/[0.12] shadow-[0_4px_20px_rgba(0,0,0,0.5)] hover:border-white/[0.25] hover:shadow-[0_4px_25px_rgba(153,69,255,0.15)]"
            } transition-all duration-500`}
            style={{ width: node.size, height: node.size }}
            animate={node.isCenter ? { boxShadow: ["0 0 30px rgba(153,69,255,0.15)", "0 0 50px rgba(153,69,255,0.3)", "0 0 30px rgba(153,69,255,0.15)"] } : undefined}
