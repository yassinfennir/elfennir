      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <StaggerContainer className="grid sm:grid-cols-2 gap-4">
            {points.map((p) => (
              <motion.div key={p.title} variants={staggerItem} style={{ transformPerspective: 800 }}>
                <Card3D className="h-full">
                  <div className="sol-card group relative p-5 rounded-3xl bg-white/[0.02] border border-white/[0.06] transition-all duration-500 overflow-hidden h-full">
