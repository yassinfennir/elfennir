        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <div className="flex items-center gap-5 mb-8">
              <div className="relative w-24 h-24 sm:w-28 sm:h-28 rounded-full overflow-hidden ring-2 ring-[#9945ff]/30 ring-offset-2 ring-offset-[#08080f] flex-shrink-0">
                <Image
              ...
              <div>
                <h3 className="text-white font-bold text-lg sm:text-xl">Yassin El Fennir</h3>
                <p className="text-[#9945ff] text-sm font-medium">{t.about.role}</p>
                <p className="text-slate-500 text-xs mt-1">{t.about.locationLabel}</p>
              </div>
            </div>
            ...
            {[
              {
                ...
                gradient: "from-[#9945ff]/15 to-[#00d1ff]/15",
              },
              {
                num: "02",
                title: t.about.value2Title,
                desc: t.about.value2Desc,
                gradient: "from-[#14f195]/15 to-[#00d1ff]/15",
              },
              {
                num: "03",
                title: t.about.value3Title,
                desc: t.about.value3Desc,
                gradient: "from-[#9945ff]/15 to-[#f971ff]/15",
              },
              {
                num: "04",
                title: t.about.value4Title,
                desc: t.about.value4Desc,
                gradient: "from-[#f971ff]/15 to-[#00d1ff]/15",
              },
            ].map((v, i) => (
              <motion.div
                key={v.num}
              ...
              >
                ...
                <div className="relative">
                  <div className="flex items-center gap-4 mb-2">
                    <span className="text-xs font-bold text-slate-600 font-[var(--font-heading)] tracking-wider">
                      {v.num}
                    </span>
