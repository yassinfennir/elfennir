...
const jsonLd = [
  {
    ...
    "@type": "LocalBusiness",
    name: "El Fennir — Webdesign Bern",
    description:
      "Professionelles Webdesign in Bern. Moderne Websites, KI-Chatbots und Automatisierung für Berner Unternehmen. Schweizer Qualität zu fairen Preisen.",
    ...
    founder: {
      ...
      description:
        "Gründer von El Fennir Digital Agency — Webdesign-Spezialist für Berner KMU",
    },
    address: {
      "@type": "PostalAddress",
      streetAddress: "Bern",
  ...
  },
  {
    "@context": "https://schema.org",
    "@type": "Service",
    name: "Webdesign Bern — Professionelle Websites",
    provider: {
      "@type": "Organization",
      name: "El Fennir",
      url: "https://elfennir.com",
    },
    areaServed: { "@type": "City", name: "Bern" },
    ...
    offers: [
      {
        ...
        priceCurrency: "CHF",
        description:
          "Moderne One-Page-Website mit SEO und mobilem Design für Berner Unternehmen",
      },
      {
        "@type": "Offer",
        ...
        priceCurrency: "CHF",
        description:
          "Mehrseitige Website mit CMS, Blog und erweiterten Funktionen für Bern",
      },
      {
        "@type": "Offer",
        ...
        priceCurrency: "CHF",
        description:
          "Komplette Website mit KI-Chatbot und Automatisierungen für Berner Unternehmen",
      },
    ],
  },
  {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "Was kostet eine professionelle Website in Bern?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Bei El Fennir beginnen professionelle Websites ab CHF 490. Je nach Umfang und Funktionen liegen die Preise zwischen CHF 490 und CHF 1'490. Deutlich günstiger als die meisten Berner Agenturen, die oft ab CHF 5'000 starten.",
        },
      },
      {
        "@type": "Question",
        name: "Wie lange dauert die Erstellung einer Website in Bern?",
        acceptedAnswer: {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        name: "Bieten Sie auch KI-Chatbots für Berner Unternehmen an?",
        acceptedAnswer: {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        name: "Kennen Sie den Berner Markt?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Wir kennen die Schweiz und den Berner Markt bestens. Von der Bundesgasse über die Altstadt bis zum Wankdorf-Quartier — wir wissen, was Berner Unternehmen brauchen.",
        },
      },
      {
        "@type": "Question",
        name: "Welche Technologien verwenden Sie für Berner Webprojekte?",
        acceptedAnswer: {
          "@type": "Answer",
...
const breadcrumbLd = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Webdesign Bern", item: "https://elfennir.com/webdesign-bern" },
  ],
};

const features = [
  {
    title: "Expertise für den Berner Markt",
    desc: "Wir verstehen die Bundesstadt und ihre Unternehmen — von der Altstadt über das Kirchenfeld bis zum Bümpliz. Lokale SEO für maximale Sichtbarkeit in Bern.",
    color: "#9945ff",
    icon: "map",
  },
  {
  ...
  },
  {
    ...
    desc: "Ab CHF 490 statt CHF 5'000+ bei lokalen Berner Agenturen. Kein Kompromiss bei Qualität — nur bei überhöhten Preisen.",
    color: "#14f195",
    icon: "price",
  },
  {
  ...
  },
  {
    ...
    desc: "Intelligente Chatbots und n8n-Workflows, die Kundenanfragen beantworten, Termine buchen und Leads qualifizieren — 24/7 für Ihr Berner Unternehmen.",
    color: "#9945ff",
    icon: "ai",
  },
  {
    title: "Mehrsprachig",
    desc: "Wir kommunizieren auf Deutsch, Englisch, Spanisch und Finnisch. Ideal für internationale Unternehmen und Botschaften in Bern.",
    color: "#00d1ff",
    icon: "globe",
  },
];
...
const services = [
  {
    ...
    desc: "Moderne, mobiloptimierte Websites, die Ihr Berner Unternehmen perfekt repräsentieren und bei Google auf Seite 1 ranken.",
    price: "Ab CHF 490",
    color: "#00d1ff",
  },
  {
    title: "KI-Chatbots",
    desc: "Intelligente Chatbots, die Kundenanfragen automatisch beantworten, Termine buchen und Leads qualifizieren — rund um die Uhr in Bern.",
    price: "Ab CHF 550",
    color: "#9945ff",
  },
  {
    title: "Automatisierung & Workflows",
    desc: "n8n-basierte Automatisierungen: E-Mail-Marketing, CRM-Integration, Social Media — massgeschneidert für Berner KMU.",
    price: "Ab CHF 350 + 90 CHF/Mt.",
    color: "#14f195",
  },
  {
    title: "SEO & Lokales Marketing",
    desc: "Suchmaschinenoptimierung speziell für Bern. Werden Sie gefunden, wenn Kunden in der Bundesstadt nach Ihren Leistungen suchen.",
    price: "Inklusive",
    color: "#f971ff",
  },
];
...
const processSteps = [
  {
    step: "01",
    title: "Erstgespräch",
    desc: "Kostenlose Beratung via WhatsApp oder E-Mail. Wir analysieren Ihre Anforderungen und definieren den Projektumfang für Ihr Berner Unternehmen.",
    color: "#9945ff",
  },
  {
    step: "02",
...
const pricing = [
  {
    name: "Starter",
    price: "CHF 490",
    subtitle: "Perfekt für Einzelunternehmer in Bern",
    features: [
      "One-Page-Website",
      "Responsives Design (Mobil + Desktop)",
      "SEO-Grundoptimierung für Bern",
      "Kontaktformular",
  ...
  },
  {
    name: "Business",
    price: "CHF 990",
    subtitle: "Für wachsende KMU in Bern",
    features: [
...
const faqs = [
  {
    q: "Was kostet eine professionelle Website in Bern?",
    a: "Bei uns beginnen professionelle Websites ab CHF 490. Je nach Umfang und Funktionen liegen die Preise zwischen CHF 490 und CHF 1'490. Das ist deutlich günstiger als die meisten Berner Agenturen, die oft ab CHF 5'000 starten — ohne Qualitätsverlust.",
  },
  {
    q: "Wie lange dauert es, bis meine Website in Bern online ist?",
  ...
  {
    q: "Kennen Sie den lokalen Markt in Bern?",
    a: "Ja, wir kennen die Schweiz und den Berner Markt bestens. Von der Altstadt und dem Bundeshaus-Quartier über das Länggass-Quartier bis zum Wankdorf — wir verstehen, was Berner Kunden suchen und wie lokale Unternehmen online gefunden werden.",
  },
  {
    q: "Erstellen Sie auch Websites für Unternehmen in der Region Bern?",
    a: "Absolut! Wir betreuen Unternehmen in Bern-Stadt, Köniz, Ostermundigen, Thun, Biel/Bienne und im ganzen Kanton Bern. Ob Gastro am Bärengraben oder IT-Startup im Wankdorf — wir liefern.",
  },
  {
    q: "Bieten Sie auch laufende Wartung und Support an?",
    a: "Ja. Nach dem Launch sind 30 Tage E-Mail-Support inklusive. Darüber hinaus bieten wir monatliche Wartungspakete an — inklusive Updates, Sicherheitschecks und Performance-Monitoring für Ihr Berner Unternehmen.",
  },
];
...
export default function WebdesignBernPage() {
  return (
    <>
      ...
      <title>
        Webdesign Bern — Professionelle Websites für Ihr Unternehmen | El
        Fennir
      </title>
      <meta
        name="description"
        content="Professionelles Webdesign in Bern. Moderne Websites, KI-Chatbots und Automatisierung für Berner Unternehmen. Ab CHF 490. Lieferung in 7 Tagen."
      />
      <meta
        name="keywords"
        content="webdesign bern, website erstellen bern, webdesign agentur bern, homepage erstellen bern, webseite bern, webentwicklung bern, ki chatbot bern, website bern kosten, professionelle website bern, webdesigner bern, seo bern, webdesign kanton bern, webdesign bundesstadt"
      />
      <meta
        property="og:title"
        content="Webdesign Bern — Professionelle Websites & KI-Automatisierung"
      />
      <meta
        property="og:description"
        content="Moderne Websites, KI-Chatbots und Automatisierung für Berner Unternehmen. Ab CHF 490. Lieferung in 7 Tagen."
      />
      <meta property="og:type" content="website" />
      <meta
        property="og:url"
        content="https://elfennir.com/webdesign-bern"
      />
      ...
      <meta
        ...
        content="Moderne Websites, KI-Chatbots und Automatisierung für Berner Unternehmen. Ab CHF 490."
      />
      <link
        rel="canonical"
        href="https://elfennir.com/webdesign-bern"
      />
      ...
      <main className="min-h-screen bg-[#08080f] text-slate-300">
        ...
        <section className="relative pt-32 pb-20 overflow-hidden">
          ...
          >
            ...
            >
              Webdesign Bern &mdash; Die Bundesstadt digital
            </motion.span>
            <motion.h1
              variants={fadeUp}
            ...
            >
              Moderne Webseiten, KI-Chatbots und Automatisierung f&uuml;r Berner
            ...
            >
              Ob KMU in der Berner Altstadt, Startup im Wankdorf oder Restaurant
              am B&auml;rengraben &mdash; wir liefern Ihre Website in 7 Tagen. Ab CHF 490,
              inklusive SEO.
            </motion.p>
            <motion.div
              variants={fadeUp}
            ...
            >
              <a
                href="https://wa.me/358466109064?text=Hallo!%20Ich%20brauche%20eine%20professionelle%20Website%20f%C3%BCr%20mein%20Unternehmen%20in%20Bern."
          ...
          <div className="max-w-5xl mx-auto px-6">
            ...
            >
              ...
              >
                ...
                Transformation &mdash; alles aus einer Hand f&uuml;r Ihr Berner
                Unternehmen.
              </motion.p>
          ...
          <div className="max-w-5xl mx-auto px-6">
            ...
            >
              ...
              >
                ...
                Berner Unternehmen &mdash; zu einem Bruchteil der &uuml;blichen
                Agenturpreise.
              </motion.p>
              <div className="grid md:grid-cols-3 gap-6">
                {pricing.map((plan, i) => (
                  ...
                  >
                    ...
                    <a
                      href={`https://wa.me/358466109064?text=Hallo!%20Ich%20interessiere%20mich%20f%C3%BCr%20das%20${encodeURIComponent(plan.name)}-Paket%20f%C3%BCr%20mein%20Unternehmen%20in%20Bern.`}
          ...
          <div className="max-w-3xl mx-auto px-6 text-center">
            ...
            >
              ...
              >
                ...
                massgeschneidertes Angebot f&uuml;r Ihr Berner Unternehmen &mdash; innerhalb von 24 Stunden.
              </motion.p>
              <motion.div
                variants={fadeUp}
                transition={{ duration: 0.5, delay: 0.2 }}
              ...
              >
                <a
                  href="https://wa.me/358466109064?text=Hallo!%20Ich%20m%C3%B6chte%20eine%20professionelle%20Website%20f%C3%BCr%20mein%20Unternehmen%20in%20Bern."
                  className="sol-btn inline-flex items-center justify-center gap-2 px-8 py-4 rounded-xl text-white font-semibold text-lg transition-all"
                >
                  <svg
                    className="w-5 h-5"
                ...
                <a
                  href="mailto:yassin@elfennir.com?subject=Webdesign-Anfrage%20Bern"
                  className="inline-flex items-center justify-center gap-2 px-8 py-4 rounded-xl border border-white/10 text-white font-semibold text-lg hover:border-[#9945ff]/40 hover:bg-white/[0.03] transition-all"
                >
                  E-Mail senden
                </a>
              ...
              >
                ...
                Webdesign f&uuml;r Bern und den ganzen Kanton
              </motion.p>
            </motion.div>
          </div>
        </section>
