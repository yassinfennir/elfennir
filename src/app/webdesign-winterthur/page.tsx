...
const jsonLd = [
  {
    ...
    "@type": "LocalBusiness",
    name: "El Fennir — Webdesign Winterthur",
    description:
      "Professionelles Webdesign in Winterthur. Moderne Websites, KI-Chatbots und Automatisierung für Winterthurer Unternehmen. Schweizer Qualität zu fairen Preisen.",
    ...
    founder: {
      ...
      description:
        "Gründer von El Fennir Digital Agency — Webdesign-Spezialist für Winterthurer KMU",
    },
    address: {
      "@type": "PostalAddress",
    ...
    areaServed: [
      ...
      { "@type": "City", name: "Wülflingen" },
      { "@type": "City", name: "Töss" },
      { "@type": "City", name: "Oberwinterthur" },
      { "@type": "City", name: "Seen" },
      { "@type": "AdministrativeArea", name: "Region Winterthur" },
    ],
  ...
  },
  {
    "@context": "https://schema.org",
    "@type": "Service",
    name: "Webdesign Winterthur — Professionelle Websites",
    provider: {
      "@type": "Organization",
      name: "El Fennir",
      url: "https://elfennir.com",
    ...
    offers: [
      {
        ...
        priceCurrency: "CHF",
        description:
          "Moderne One-Page-Website mit SEO und mobilem Design für Winterthurer Unternehmen",
      },
      {
        "@type": "Offer",
        ...
        priceCurrency: "CHF",
        description:
          "Mehrseitige Website mit CMS, Blog und erweiterten Funktionen für Winterthur",
      },
      {
        "@type": "Offer",
        ...
        priceCurrency: "CHF",
        description:
          "Komplette Website mit KI-Chatbot und Automatisierungen für Winterthurer Unternehmen",
      },
    ],
  },
  {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "Was kostet eine professionelle Website in Winterthur?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Bei El Fennir beginnen professionelle Websites ab CHF 490. Je nach Umfang und Funktionen liegen die Preise zwischen CHF 490 und CHF 1'490. Deutlich günstiger als die meisten Winterthurer Agenturen, die oft ab CHF 5'000 starten.",
        },
      },
      {
        "@type": "Question",
        name: "Wie lange dauert die Erstellung einer Website in Winterthur?",
        acceptedAnswer: {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        name: "Bieten Sie auch KI-Chatbots für Winterthurer Unternehmen an?",
        acceptedAnswer: {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        name: "Kennen Sie den Winterthurer Markt und die lokale Wirtschaft?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Ja, wir kennen Winterthur als sechstgrösste Stadt der Schweiz mit ihrer starken Industriegeschichte, dem Technopark und dem wachsenden Startup-Ökosystem. Wir erstellen Websites, die den Winterthurer Markt gezielt ansprechen.",
        },
      },
      {
        "@type": "Question",
        name: "Welche Technologien verwenden Sie für Winterthurer Webprojekte?",
        acceptedAnswer: {
          "@type": "Answer",
...
const breadcrumbLd = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Webdesign Winterthur", item: "https://elfennir.com/webdesign-winterthur" },
  ],
};

const features = [
  {
    title: "Expertise für den Winterthurer Markt",
    desc: "Wir kennen Winterthur — von der Altstadt über den Technopark bis zum Sulzer-Areal. Lokale SEO für maximale Sichtbarkeit bei Winterthurer Kunden.",
    color: "#9945ff",
    icon: "map",
  },
  {
  ...
  },
  {
    ...
    desc: "Ab CHF 490 statt CHF 5'000+ bei lokalen Winterthurer Agenturen. Kein Kompromiss bei Qualität — nur bei überhöhten Preisen.",
    color: "#14f195",
    icon: "price",
  },
  {
  ...
  },
  {
    ...
    desc: "Intelligente Chatbots und n8n-Workflows, die Kundenanfragen beantworten, Termine buchen und Leads qualifizieren — 24/7 für Ihr Winterthurer Unternehmen.",
    color: "#9945ff",
    icon: "ai",
  },
  {
    title: "Mehrsprachig",
    desc: "Wir kommunizieren auf Deutsch, Englisch, Spanisch und Finnisch. Ideal für internationale Unternehmen am Standort Winterthur.",
    color: "#00d1ff",
    icon: "globe",
  },
];
...
const services = [
  {
    ...
    desc: "Moderne, mobiloptimierte Websites, die Ihr Winterthurer Unternehmen perfekt repräsentieren und bei Google auf Seite 1 ranken.",
    price: "Ab CHF 490",
    color: "#00d1ff",
  },
  {
    title: "KI-Chatbots",
    desc: "Intelligente Chatbots, die Kundenanfragen automatisch beantworten, Termine buchen und Leads qualifizieren — rund um die Uhr in Winterthur.",
    price: "Ab CHF 550",
    color: "#9945ff",
  },
  {
    title: "Automatisierung & Workflows",
    desc: "n8n-basierte Automatisierungen: E-Mail-Marketing, CRM-Integration, Social Media — massgeschneidert für Winterthurer KMU und Industrieunternehmen.",
    price: "Ab CHF 350 + 90 CHF/Mt.",
    color: "#14f195",
  },
  {
    title: "SEO & Lokales Marketing",
    desc: "Suchmaschinenoptimierung speziell für Winterthur. Werden Sie gefunden, wenn Kunden in der Eulachstadt nach Ihren Leistungen suchen.",
    price: "Inklusive",
    color: "#f971ff",
  },
];
...
const processSteps = [
  {
    step: "01",
    title: "Erstgespräch",
    desc: "Kostenlose Beratung via WhatsApp oder E-Mail. Wir analysieren Ihre Anforderungen und definieren den Projektumfang für Ihr Winterthurer Unternehmen.",
    color: "#9945ff",
  },
  {
    step: "02",
...
const pricing = [
  {
    name: "Starter",
    price: "CHF 490",
    subtitle: "Perfekt für Einzelunternehmer in Winterthur",
    features: [
      "One-Page-Website",
      "Responsives Design (Mobil + Desktop)",
      "SEO-Grundoptimierung für Winterthur",
      "Kontaktformular",
  ...
  },
  {
    name: "Business",
    price: "CHF 990",
    subtitle: "Für wachsende KMU in Winterthur",
    features: [
...
const faqs = [
  {
    q: "Was kostet eine professionelle Website in Winterthur?",
    a: "Bei uns beginnen professionelle Websites ab CHF 490. Je nach Umfang und Funktionen liegen die Preise zwischen CHF 490 und CHF 1'490. Das ist deutlich günstiger als die meisten Winterthurer Agenturen, die oft ab CHF 5'000 starten — ohne Qualitätsverlust.",
  },
  {
    q: "Wie lange dauert es, bis meine Website in Winterthur online ist?",
  ...
  {
    q: "Kennen Sie den lokalen Markt in Winterthur?",
    a: "Ja! Winterthur ist die sechstgrösste Stadt der Schweiz mit einer starken Industriegeschichte — vom Sulzer-Areal zum modernen Technopark. Wir verstehen das lokale Gewerbe und erstellen Websites, die Winterthurer Kunden gezielt ansprechen.",
  },
  {
    q: "Betreuen Sie auch Unternehmen in der Region Winterthur?",
    a: "Absolut! Wir betreuen Unternehmen in Winterthur-Stadt, Wülflingen, Töss, Oberwinterthur, Seen und der ganzen Region. Remote-Zusammenarbeit ermöglicht schnelle und effiziente Projekte.",
  },
  {
    q: "Bieten Sie auch laufende Wartung und Support an?",
    a: "Ja. Nach dem Launch sind 30 Tage E-Mail-Support inklusive. Darüber hinaus bieten wir monatliche Wartungspakete an — inklusive Updates, Sicherheitschecks und Performance-Monitoring für Ihr Winterthurer Unternehmen.",
  },
];
...
export default function WebdesignWinterthurPage() {
  return (
    <>
      ...
      <title>
        Webdesign Winterthur — Professionelle Websites für Ihr Unternehmen | El
        Fennir
      </title>
      <meta
        name="description"
        content="Professionelles Webdesign in Winterthur. Moderne Websites, KI-Chatbots und Automatisierung für Winterthurer Unternehmen. Ab CHF 490. Lieferung in 7 Tagen."
      />
      <meta
        name="keywords"
        content="webdesign winterthur, website erstellen winterthur, webdesign agentur winterthur, homepage erstellen winterthur, webseite winterthur, webentwicklung winterthur, ki chatbot winterthur, website winterthur kosten, professionelle website winterthur, webdesigner winterthur, seo winterthur, webdesign eulachstadt"
      />
      <meta
        property="og:title"
        content="Webdesign Winterthur — Professionelle Websites & KI-Automatisierung"
      />
      <meta
        property="og:description"
        content="Moderne Websites, KI-Chatbots und Automatisierung für Winterthurer Unternehmen. Ab CHF 490. Lieferung in 7 Tagen."
      />
      <meta property="og:type" content="website" />
      <meta
        property="og:url"
        content="https://elfennir.com/webdesign-winterthur"
      />
      ...
      <meta
        ...
        content="Moderne Websites, KI-Chatbots und Automatisierung für Winterthurer Unternehmen. Ab CHF 490."
      />
      <link
        rel="canonical"
        href="https://elfennir.com/webdesign-winterthur"
      />
      ...
      <main className="min-h-screen bg-[#08080f] text-slate-300">
        ...
        <section className="relative pt-32 pb-20 overflow-hidden">
          ...
          >
            ...
            >
              Webdesign Winterthur &mdash; Die Eulachstadt digital
            </motion.span>
            <motion.h1
              variants={fadeUp}
            ...
            >
              Moderne Webseiten, KI-Chatbots und Automatisierung f&uuml;r Winterthurer
              Unternehmen. Schweizer Qualit&auml;t, modernste Technologie und faire
              Preise in CHF.
            </motion.p>
            <motion.p
              variants={fadeUp}
            ...
            >
              Ob Startup im Technopark, KMU in der Altstadt oder Gewerbe im
              Sulzer-Areal &mdash; wir liefern Ihre Website in 7 Tagen. Ab CHF 490,
              inklusive SEO.
            </motion.p>
            <motion.div
              variants={fadeUp}
            ...
            >
              <a
                href="https://wa.me/358466109064?text=Hallo!%20Ich%20brauche%20eine%20professionelle%20Website%20f%C3%BCr%20mein%20Unternehmen%20in%20Winterthur."
          ...
          <div className="max-w-5xl mx-auto px-6">
            ...
            >
              ...
              >
                ...
                Transformation &mdash; alles aus einer Hand f&uuml;r Ihr Winterthurer
                Unternehmen.
              </motion.p>
        ...
        <section className="py-20">
          <div className="max-w-5xl mx-auto px-6">
            ...
            >
              ...
              >
                Warum Winterthurer Unternehmen{" "}
              ...
              <motion.p
                ...
                className="text-slate-400 text-center max-w-2xl mx-auto mb-14"
              >
                Wir kombinieren Marktkenntnis mit modernster Technologie
          ...
          <div className="max-w-5xl mx-auto px-6">
            ...
            >
              ...
              >
                ...
                Winterthurer Unternehmen &mdash; zu einem Bruchteil der &uuml;blichen
                Agenturpreise.
              </motion.p>
              <div className="grid md:grid-cols-3 gap-6">
                {pricing.map((plan, i) => (
                  ...
                  >
                    ...
                    <a
                      href={`https://wa.me/358466109064?text=Hallo!%20Ich%20interessiere%20mich%20f%C3%BCr%20das%20${encodeURIComponent(plan.name)}-Paket%20f%C3%BCr%20mein%20Unternehmen%20in%20Winterthur.`}
          ...
          <div className="max-w-3xl mx-auto px-6 text-center">
            ...
            >
              ...
              >
                ...
                massgeschneidertes Angebot f&uuml;r Ihr Winterthurer Unternehmen &mdash; innerhalb von 24 Stunden.
              </motion.p>
              <motion.div
                variants={fadeUp}
                transition={{ duration: 0.5, delay: 0.2 }}
              ...
              >
                <a
                  href="https://wa.me/358466109064?text=Hallo!%20Ich%20m%C3%B6chte%20eine%20professionelle%20Website%20f%C3%BCr%20mein%20Unternehmen%20in%20Winterthur."
                  className="sol-btn inline-flex items-center justify-center gap-2 px-8 py-4 rounded-xl text-white font-semibold text-lg transition-all"
                >
                  <svg
                    className="w-5 h-5"
                ...
                <a
                  href="mailto:yassin@elfennir.com?subject=Webdesign-Anfrage%20Winterthur"
                  className="inline-flex items-center justify-center gap-2 px-8 py-4 rounded-xl border border-white/10 text-white font-semibold text-lg hover:border-[#9945ff]/40 hover:bg-white/[0.03] transition-all"
                >
                  E-Mail senden
                </a>
              ...
              >
                ...
                Webdesign f&uuml;r Winterthur und die ganze Region
              </motion.p>
            </motion.div>
          </div>
        </section>
