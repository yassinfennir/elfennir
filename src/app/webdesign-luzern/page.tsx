...
const jsonLd = [
  {
    ...
    "@type": "LocalBusiness",
    name: "El Fennir — Webdesign Luzern",
    description:
      "Professionelles Webdesign in Luzern. Moderne Websites, KI-Chatbots und Automatisierung für Luzerner Unternehmen. Schweizer Qualität zu fairen Preisen.",
    ...
    founder: {
      ...
      description:
        "Gründer von El Fennir Digital Agency — Webdesign-Spezialist für Luzerner KMU",
    },
    address: {
      "@type": "PostalAddress",
      streetAddress: "Luzern",
  ...
  },
  {
    "@context": "https://schema.org",
    "@type": "Service",
    name: "Webdesign Luzern — Professionelle Websites",
    provider: {
      "@type": "Organization",
      name: "El Fennir",
      url: "https://elfennir.com",
    ...
    offers: [
      {
        ...
        priceCurrency: "CHF",
        description:
          "Moderne One-Page-Website mit SEO und mobilem Design für Luzerner Unternehmen",
      },
      {
        "@type": "Offer",
        ...
        priceCurrency: "CHF",
        description:
          "Mehrseitige Website mit CMS, Blog und erweiterten Funktionen für Luzern",
      },
      {
        "@type": "Offer",
        ...
        priceCurrency: "CHF",
        description:
          "Komplette Website mit KI-Chatbot und Automatisierungen für Luzerner Unternehmen",
      },
    ],
  },
  {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "Was kostet eine professionelle Website in Luzern?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Bei El Fennir beginnen professionelle Websites ab CHF 490. Je nach Umfang und Funktionen liegen die Preise zwischen CHF 490 und CHF 1'490. Deutlich günstiger als die meisten Luzerner Agenturen, die oft ab CHF 5'000 starten.",
        },
      },
      {
        "@type": "Question",
        name: "Wie lange dauert die Erstellung einer Website in Luzern?",
        acceptedAnswer: {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        name: "Bieten Sie auch KI-Chatbots für Luzerner Unternehmen an?",
        acceptedAnswer: {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        name: "Erstellen Sie auch Websites für die Tourismusbranche in Luzern?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Ja! Luzern ist ein Top-Tourismus-Standort mit der Kapellbrücke, dem Vierwaldstättersee und dem Pilatus. Wir erstellen mehrsprachige Websites für Hotels, Restaurants und Erlebnisanbieter in der Region Luzern.",
        },
      },
      {
        "@type": "Question",
        name: "Welche Technologien verwenden Sie für Luzerner Webprojekte?",
        acceptedAnswer: {
          "@type": "Answer",
...
const breadcrumbLd = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Webdesign Luzern", item: "https://elfennir.com/webdesign-luzern" },
  ],
};

const features = [
  {
    title: "Expertise für den Luzerner Markt",
    desc: "Wir kennen Luzern und die Zentralschweiz — von der Kapellbrücke über das KKL bis zum Tribschen-Quartier. Lokale SEO für maximale Sichtbarkeit in Luzern.",
    color: "#9945ff",
    icon: "map",
  },
  {
  ...
  },
  {
    ...
    desc: "Ab CHF 490 statt CHF 5'000+ bei lokalen Luzerner Agenturen. Kein Kompromiss bei Qualität — nur bei überhöhten Preisen.",
    color: "#14f195",
    icon: "price",
  },
  {
  ...
  },
  {
    ...
    desc: "Intelligente Chatbots und n8n-Workflows, die Kundenanfragen beantworten, Termine buchen und Leads qualifizieren — 24/7 für Ihr Luzerner Unternehmen.",
    color: "#9945ff",
    icon: "ai",
  },
  {
    title: "Mehrsprachig",
    desc: "Wir kommunizieren auf Deutsch, Englisch, Spanisch und Finnisch. Ideal für internationale Tourismus-Unternehmen in Luzern.",
    color: "#00d1ff",
    icon: "globe",
  },
];
...
const services = [
  {
    ...
    desc: "Moderne, mobiloptimierte Websites, die Ihr Luzerner Unternehmen perfekt repräsentieren und bei Google auf Seite 1 ranken.",
    price: "Ab CHF 490",
    color: "#00d1ff",
  },
  {
    title: "KI-Chatbots",
    desc: "Intelligente Chatbots, die Kundenanfragen automatisch beantworten, Termine buchen und Leads qualifizieren — rund um die Uhr in Luzern.",
    price: "Ab CHF 550",
    color: "#9945ff",
  },
  {
    title: "Automatisierung & Workflows",
    desc: "n8n-basierte Automatisierungen: E-Mail-Marketing, CRM-Integration, Social Media — massgeschneidert für Luzerner KMU und Tourismusbetriebe.",
    price: "Ab CHF 350 + 90 CHF/Mt.",
    color: "#14f195",
  },
  {
    title: "SEO & Lokales Marketing",
    desc: "Suchmaschinenoptimierung speziell für Luzern und die Zentralschweiz. Werden Sie gefunden, wenn Kunden nach Ihren Leistungen suchen.",
    price: "Inklusive",
    color: "#f971ff",
  },
];
...
const processSteps = [
  {
    step: "01",
    title: "Erstgespräch",
    desc: "Kostenlose Beratung via WhatsApp oder E-Mail. Wir analysieren Ihre Anforderungen und definieren den Projektumfang für Ihr Luzerner Unternehmen.",
    color: "#9945ff",
  },
  {
    step: "02",
...
const pricing = [
  {
    name: "Starter",
    price: "CHF 490",
    subtitle: "Perfekt für Einzelunternehmer in Luzern",
    features: [
      "One-Page-Website",
      "Responsives Design (Mobil + Desktop)",
      "SEO-Grundoptimierung für Luzern",
      "Kontaktformular",
  ...
  },
  {
    name: "Business",
    price: "CHF 990",
    subtitle: "Für wachsende KMU in Luzern",
    features: [
...
const faqs = [
  {
    q: "Was kostet eine professionelle Website in Luzern?",
    a: "Bei uns beginnen professionelle Websites ab CHF 490. Je nach Umfang und Funktionen liegen die Preise zwischen CHF 490 und CHF 1'490. Das ist deutlich günstiger als die meisten Luzerner Agenturen, die oft ab CHF 5'000 starten — ohne Qualitätsverlust.",
  },
  {
    q: "Wie lange dauert es, bis meine Website in Luzern online ist?",
  ...
  {
    q: "Erstellen Sie auch mehrsprachige Websites für die Tourismusbranche?",
    a: "Ja! Luzern ist einer der beliebtesten Tourismusorte der Schweiz — mit der Kapellbrücke, dem Vierwaldstättersee und dem Pilatus. Wir erstellen mehrsprachige Websites (DE/EN/FR/IT) für Hotels, Restaurants und Erlebnisanbieter in der Region.",
  },
  {
    q: "Betreuen Sie auch Unternehmen in der ganzen Zentralschweiz?",
    a: "Absolut! Wir betreuen Unternehmen in Luzern-Stadt, Kriens, Emmen, Horw, Ebikon und der gesamten Zentralschweiz. Remote-Zusammenarbeit ermöglicht schnelle und effiziente Projekte — egal wo Sie in der Region sind.",
  },
  {
    q: "Bieten Sie auch laufende Wartung und Support an?",
    a: "Ja. Nach dem Launch sind 30 Tage E-Mail-Support inklusive. Darüber hinaus bieten wir monatliche Wartungspakete an — inklusive Updates, Sicherheitschecks und Performance-Monitoring für Ihr Luzerner Unternehmen.",
  },
];
...
export default function WebdesignLuzernPage() {
  return (
    <>
      ...
      <title>
        Webdesign Luzern — Professionelle Websites für Ihr Unternehmen | El
        Fennir
      </title>
      <meta
        name="description"
        content="Professionelles Webdesign in Luzern. Moderne Websites, KI-Chatbots und Automatisierung für Luzerner Unternehmen. Ab CHF 490. Lieferung in 7 Tagen."
      />
      <meta
        name="keywords"
        content="webdesign luzern, website erstellen luzern, webdesign agentur luzern, homepage erstellen luzern, webseite luzern, webentwicklung luzern, ki chatbot luzern, website luzern kosten, professionelle website luzern, webdesigner luzern, seo luzern, webdesign zentralschweiz"
      />
      <meta
        property="og:title"
        content="Webdesign Luzern — Professionelle Websites & KI-Automatisierung"
      />
      <meta
        property="og:description"
        content="Moderne Websites, KI-Chatbots und Automatisierung für Luzerner Unternehmen. Ab CHF 490. Lieferung in 7 Tagen."
      />
      <meta property="og:type" content="website" />
      <meta
        property="og:url"
        content="https://elfennir.com/webdesign-luzern"
      />
      ...
      <meta
        ...
        content="Moderne Websites, KI-Chatbots und Automatisierung für Luzerner Unternehmen. Ab CHF 490."
      />
      <link
        rel="canonical"
        href="https://elfennir.com/webdesign-luzern"
      />
      ...
      <main className="min-h-screen bg-[#08080f] text-slate-300">
        ...
        <section className="relative pt-32 pb-20 overflow-hidden">
          ...
          >
            ...
            >
              Webdesign Luzern &mdash; Perle der Zentralschweiz
            </motion.span>
            <motion.h1
              variants={fadeUp}
            ...
            >
              Moderne Webseiten, KI-Chatbots und Automatisierung f&uuml;r Luzerner
            ...
            >
              Ob Hotel am Vierwaldst&auml;ttersee, KMU in Kriens oder Restaurant
              in der Luzerner Altstadt &mdash; wir liefern Ihre Website in 7 Tagen. Ab CHF 490,
              inklusive SEO.
            </motion.p>
            <motion.div
              variants={fadeUp}
            ...
            >
              <a
                href="https://wa.me/358466109064?text=Hallo!%20Ich%20brauche%20eine%20professionelle%20Website%20f%C3%BCr%20mein%20Unternehmen%20in%20Luzern."
          ...
          <div className="max-w-5xl mx-auto px-6">
            ...
            >
              ...
              >
                ...
                Transformation &mdash; alles aus einer Hand f&uuml;r Ihr Luzerner
                Unternehmen.
              </motion.p>
          ...
          <div className="max-w-5xl mx-auto px-6">
            ...
            >
              ...
              >
                ...
                Luzerner Unternehmen &mdash; zu einem Bruchteil der &uuml;blichen
                Agenturpreise.
              </motion.p>
              <div className="grid md:grid-cols-3 gap-6">
                {pricing.map((plan, i) => (
                  ...
                  >
                    ...
                    <a
                      href={`https://wa.me/358466109064?text=Hallo!%20Ich%20interessiere%20mich%20f%C3%BCr%20das%20${encodeURIComponent(plan.name)}-Paket%20f%C3%BCr%20mein%20Unternehmen%20in%20Luzern.`}
          ...
          <div className="max-w-3xl mx-auto px-6 text-center">
            ...
            >
              ...
              >
                ...
                massgeschneidertes Angebot f&uuml;r Ihr Luzerner Unternehmen &mdash; innerhalb von 24 Stunden.
              </motion.p>
              <motion.div
                variants={fadeUp}
                transition={{ duration: 0.5, delay: 0.2 }}
              ...
              >
                <a
                  href="https://wa.me/358466109064?text=Hallo!%20Ich%20m%C3%B6chte%20eine%20professionelle%20Website%20f%C3%BCr%20mein%20Unternehmen%20in%20Luzern."
                  className="sol-btn inline-flex items-center justify-center gap-2 px-8 py-4 rounded-xl text-white font-semibold text-lg transition-all"
                >
                  <svg
                    className="w-5 h-5"
                ...
                <a
                  href="mailto:yassin@elfennir.com?subject=Webdesign-Anfrage%20Luzern"
                  className="inline-flex items-center justify-center gap-2 px-8 py-4 rounded-xl border border-white/10 text-white font-semibold text-lg hover:border-[#9945ff]/40 hover:bg-white/[0.03] transition-all"
                >
                  E-Mail senden
                </a>
              ...
              >
                ...
                Webdesign f&uuml;r Luzern und die ganze Zentralschweiz
              </motion.p>
            </motion.div>
          </div>
        </section>
