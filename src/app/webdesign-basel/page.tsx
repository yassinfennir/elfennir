...
const jsonLd = [
  {
    ...
    "@type": "LocalBusiness",
    name: "El Fennir — Webdesign Basel",
    description:
      "Professionelles Webdesign in Basel. Moderne Websites, KI-Chatbots und Automatisierung für Basler Unternehmen. Schweizer Qualität zu fairen Preisen.",
    ...
    founder: {
      ...
      description:
        "Gründer von El Fennir Digital Agency — Webdesign-Spezialist für Basler KMU",
    },
    address: {
      "@type": "PostalAddress",
      streetAddress: "Basel",
    ...
    areaServed: [
      ...
      { "@type": "City", name: "Muttenz" },
      { "@type": "AdministrativeArea", name: "Kanton Basel-Stadt" },
      { "@type": "AdministrativeArea", name: "Kanton Basel-Landschaft" },
    ],
  ...
  },
  {
    "@context": "https://schema.org",
    "@type": "Service",
    name: "Webdesign Basel — Professionelle Websites",
    provider: {
      "@type": "Organization",
      name: "El Fennir",
      url: "https://elfennir.com",
    ...
    offers: [
      {
        ...
        priceCurrency: "CHF",
        description:
          "Moderne One-Page-Website mit SEO und mobilem Design für Basler Unternehmen",
      },
      {
        "@type": "Offer",
        ...
        priceCurrency: "CHF",
        description:
          "Mehrseitige Website mit CMS, Blog und erweiterten Funktionen für Basel",
      },
      {
        "@type": "Offer",
        ...
        priceCurrency: "CHF",
        description:
          "Komplette Website mit KI-Chatbot und Automatisierungen für Basler Unternehmen",
      },
    ],
  },
  {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "Was kostet eine professionelle Website in Basel?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Bei El Fennir beginnen professionelle Websites ab CHF 490. Je nach Umfang und Funktionen liegen die Preise zwischen CHF 490 und CHF 1'490. Deutlich günstiger als die meisten Basler Agenturen, die oft ab CHF 5'000 starten.",
        },
      },
      {
        "@type": "Question",
        name: "Wie lange dauert die Erstellung einer Website in Basel?",
        acceptedAnswer: {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        name: "Bieten Sie auch KI-Chatbots für Basler Unternehmen an?",
        acceptedAnswer: {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        name: "Erstellen Sie Websites für die Pharma- und Life-Sciences-Branche in Basel?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Absolut! Basel ist das Zentrum der Pharma- und Life-Sciences-Industrie. Wir erstellen professionelle Websites für Unternehmen aller Branchen in Basel — von Startups im Basel Area bis zu etablierten KMU.",
        },
      },
      {
        "@type": "Question",
        name: "Welche Technologien verwenden Sie für Basler Webprojekte?",
        acceptedAnswer: {
          "@type": "Answer",
...
const breadcrumbLd = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Webdesign Basel", item: "https://elfennir.com/webdesign-basel" },
  ],
};

const features = [
  {
    title: "Expertise für den Basler Markt",
    desc: "Wir verstehen Basel und seine Wirtschaft — von der Pharmabranche am Novartis Campus über das Messegelände bis zur Freien Strasse. Lokale SEO für maximale Sichtbarkeit.",
    color: "#9945ff",
    icon: "map",
  },
  {
  ...
  },
  {
    ...
    desc: "Ab CHF 490 statt CHF 5'000+ bei lokalen Basler Agenturen. Kein Kompromiss bei Qualität — nur bei überhöhten Preisen.",
    color: "#14f195",
    icon: "price",
  },
  {
  ...
  },
  {
    ...
    desc: "Intelligente Chatbots und n8n-Workflows, die Kundenanfragen beantworten, Termine buchen und Leads qualifizieren — 24/7 für Ihr Basler Unternehmen.",
    color: "#9945ff",
    icon: "ai",
  },
  {
    title: "Mehrsprachig",
    desc: "Wir kommunizieren auf Deutsch, Englisch, Spanisch und Finnisch. Ideal für internationale Unternehmen und die trinationale Region Basel.",
    color: "#00d1ff",
    icon: "globe",
  },
];
...
const services = [
  {
    ...
    desc: "Moderne, mobiloptimierte Websites, die Ihr Basler Unternehmen perfekt repräsentieren und bei Google auf Seite 1 ranken.",
    price: "Ab CHF 490",
    color: "#00d1ff",
  },
  {
    title: "KI-Chatbots",
    desc: "Intelligente Chatbots, die Kundenanfragen automatisch beantworten, Termine buchen und Leads qualifizieren — rund um die Uhr in Basel.",
    price: "Ab CHF 550",
    color: "#9945ff",
  },
  {
    title: "Automatisierung & Workflows",
    desc: "n8n-basierte Automatisierungen: E-Mail-Marketing, CRM-Integration, Social Media — massgeschneidert für Basler KMU und Startups.",
    price: "Ab CHF 350 + 90 CHF/Mt.",
    color: "#14f195",
  },
  {
    title: "SEO & Lokales Marketing",
    desc: "Suchmaschinenoptimierung speziell für Basel. Werden Sie gefunden, wenn Kunden in der Rheinkniestadt nach Ihren Leistungen suchen.",
    price: "Inklusive",
    color: "#f971ff",
  },
];
...
const processSteps = [
  {
    step: "01",
    title: "Erstgespräch",
    desc: "Kostenlose Beratung via WhatsApp oder E-Mail. Wir analysieren Ihre Anforderungen und definieren den Projektumfang für Ihr Basler Unternehmen.",
    color: "#9945ff",
  },
  {
    step: "02",
...
const pricing = [
  {
    name: "Starter",
    price: "CHF 490",
    subtitle: "Perfekt für Einzelunternehmer in Basel",
    features: [
      "One-Page-Website",
      "Responsives Design (Mobil + Desktop)",
      "SEO-Grundoptimierung für Basel",
      "Kontaktformular",
  ...
  },
  {
    name: "Business",
    price: "CHF 990",
    subtitle: "Für wachsende KMU in Basel",
    features: [
...
const faqs = [
  {
    q: "Was kostet eine professionelle Website in Basel?",
    a: "Bei uns beginnen professionelle Websites ab CHF 490. Je nach Umfang und Funktionen liegen die Preise zwischen CHF 490 und CHF 1'490. Das ist deutlich günstiger als die meisten Basler Agenturen, die oft ab CHF 5'000 starten — ohne Qualitätsverlust.",
  },
  {
    q: "Wie lange dauert es, bis meine Website in Basel online ist?",
  ...
  {
    q: "Erstellen Sie Websites für die Pharma- und Life-Sciences-Branche?",
    a: "Absolut! Basel ist das Herz der Schweizer Pharma- und Life-Sciences-Industrie mit Novartis und Roche. Wir erstellen professionelle Websites für Unternehmen aller Branchen — vom Startup im Basel Area bis zum KMU an der Freien Strasse.",
  },
  {
    q: "Betreuen Sie auch Unternehmen in Basel-Landschaft?",
    a: "Ja, wir betreuen Unternehmen in ganz Basel-Stadt und Basel-Landschaft — Riehen, Allschwil, Binningen, Muttenz und die gesamte Dreiländerecke. Remote-Zusammenarbeit ermöglicht schnelle und effiziente Projekte.",
  },
  {
    q: "Bieten Sie auch laufende Wartung und Support an?",
    a: "Ja. Nach dem Launch sind 30 Tage E-Mail-Support inklusive. Darüber hinaus bieten wir monatliche Wartungspakete an — inklusive Updates, Sicherheitschecks und Performance-Monitoring für Ihr Basler Unternehmen.",
  },
];
...
export default function WebdesignBaselPage() {
  return (
    <>
      ...
      <title>
        Webdesign Basel — Professionelle Websites für Ihr Unternehmen | El
        Fennir
      </title>
      <meta
        name="description"
        content="Professionelles Webdesign in Basel. Moderne Websites, KI-Chatbots und Automatisierung für Basler Unternehmen. Ab CHF 490. Lieferung in 7 Tagen."
      />
      <meta
        name="keywords"
        content="webdesign basel, website erstellen basel, webdesign agentur basel, homepage erstellen basel, webseite basel, webentwicklung basel, ki chatbot basel, website basel kosten, professionelle website basel, webdesigner basel, seo basel, webdesign kanton basel, webdesign rheinknie"
      />
      <meta
        property="og:title"
        content="Webdesign Basel — Professionelle Websites & KI-Automatisierung"
      />
      <meta
        property="og:description"
        content="Moderne Websites, KI-Chatbots und Automatisierung für Basler Unternehmen. Ab CHF 490. Lieferung in 7 Tagen."
      />
      <meta property="og:type" content="website" />
      <meta
        property="og:url"
        content="https://elfennir.com/webdesign-basel"
      />
      ...
      <meta
        ...
        content="Moderne Websites, KI-Chatbots und Automatisierung für Basler Unternehmen. Ab CHF 490."
      />
      <link
        rel="canonical"
        href="https://elfennir.com/webdesign-basel"
      />
      ...
      <main className="min-h-screen bg-[#08080f] text-slate-300">
        ...
        <section className="relative pt-32 pb-20 overflow-hidden">
          ...
          >
            ...
            >
              Webdesign Basel &mdash; Die Rheinkniestadt digital
            </motion.span>
            <motion.h1
              variants={fadeUp}
            ...
            >
              Moderne Webseiten, KI-Chatbots und Automatisierung f&uuml;r Basler
            ...
            >
              Ob Pharma-Startup am Novartis Campus, KMU an der Freien Strasse oder
              Restaurant in Kleinbasel &mdash; wir liefern Ihre Website in 7 Tagen. Ab CHF 490,
              inklusive SEO.
            </motion.p>
            <motion.div
              variants={fadeUp}
            ...
            >
              <a
                href="https://wa.me/358466109064?text=Hallo!%20Ich%20brauche%20eine%20professionelle%20Website%20f%C3%BCr%20mein%20Unternehmen%20in%20Basel."
          ...
          <div className="max-w-5xl mx-auto px-6">
            ...
            >
              ...
              >
                ...
                Transformation &mdash; alles aus einer Hand f&uuml;r Ihr Basler
                Unternehmen.
              </motion.p>
          ...
          <div className="max-w-5xl mx-auto px-6">
            ...
            >
              ...
              >
                ...
                Basler Unternehmen &mdash; zu einem Bruchteil der &uuml;blichen
                Agenturpreise.
              </motion.p>
              <div className="grid md:grid-cols-3 gap-6">
                {pricing.map((plan, i) => (
                  ...
                  >
                    ...
                    <a
                      href={`https://wa.me/358466109064?text=Hallo!%20Ich%20interessiere%20mich%20f%C3%BCr%20das%20${encodeURIComponent(plan.name)}-Paket%20f%C3%BCr%20mein%20Unternehmen%20in%20Basel.`}
          ...
          <div className="max-w-3xl mx-auto px-6 text-center">
            ...
            >
              ...
              >
                ...
                massgeschneidertes Angebot f&uuml;r Ihr Basler Unternehmen &mdash; innerhalb von 24 Stunden.
              </motion.p>
              <motion.div
                variants={fadeUp}
                transition={{ duration: 0.5, delay: 0.2 }}
              ...
              >
                <a
                  href="https://wa.me/358466109064?text=Hallo!%20Ich%20m%C3%B6chte%20eine%20professionelle%20Website%20f%C3%BCr%20mein%20Unternehmen%20in%20Basel."
                  className="sol-btn inline-flex items-center justify-center gap-2 px-8 py-4 rounded-xl text-white font-semibold text-lg transition-all"
                >
                  <svg
                    className="w-5 h-5"
                ...
                <a
                  href="mailto:yassin@elfennir.com?subject=Webdesign-Anfrage%20Basel"
                  className="inline-flex items-center justify-center gap-2 px-8 py-4 rounded-xl border border-white/10 text-white font-semibold text-lg hover:border-[#9945ff]/40 hover:bg-white/[0.03] transition-all"
                >
                  E-Mail senden
                </a>
              ...
              >
                ...
                Webdesign f&uuml;r Basel und die ganze Region
              </motion.p>
            </motion.div>
          </div>
        </section>
