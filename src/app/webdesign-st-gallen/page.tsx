...
const jsonLd = [
  {
    ...
    "@type": "LocalBusiness",
    name: "El Fennir — Webdesign St. Gallen",
    description:
      "Professionelles Webdesign in St. Gallen. Moderne Websites, KI-Chatbots und Automatisierung für St. Galler Unternehmen. Schweizer Qualität zu fairen Preisen.",
    ...
    founder: {
      ...
      description:
        "Gründer von El Fennir Digital Agency — Webdesign-Spezialist für St. Galler KMU",
    },
    address: {
      "@type": "PostalAddress",
      streetAddress: "St. Gallen",
    ...
    areaServed: [
      ...
      { "@type": "City", name: "Gossau" },
      { "@type": "City", name: "Herisau" },
      { "@type": "City", name: "Wil" },
  ...
  },
  {
    "@context": "https://schema.org",
    "@type": "Service",
    name: "Webdesign St. Gallen — Professionelle Websites",
    provider: {
      "@type": "Organization",
      name: "El Fennir",
      url: "https://elfennir.com",
    ...
    offers: [
      {
        ...
        priceCurrency: "CHF",
        description:
          "Moderne One-Page-Website mit SEO und mobilem Design für St. Galler Unternehmen",
      },
      {
        "@type": "Offer",
        ...
        priceCurrency: "CHF",
        description:
          "Mehrseitige Website mit CMS, Blog und erweiterten Funktionen für St. Gallen",
      },
      {
        "@type": "Offer",
        ...
        priceCurrency: "CHF",
        description:
          "Komplette Website mit KI-Chatbot und Automatisierungen für St. Galler Unternehmen",
      },
    ],
  },
  {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "Was kostet eine professionelle Website in St. Gallen?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Bei El Fennir beginnen professionelle Websites ab CHF 490. Je nach Umfang und Funktionen liegen die Preise zwischen CHF 490 und CHF 1'490. Deutlich günstiger als die meisten St. Galler Agenturen, die oft ab CHF 5'000 starten.",
        },
      },
      {
        "@type": "Question",
        name: "Wie lange dauert die Erstellung einer Website in St. Gallen?",
        acceptedAnswer: {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        name: "Bieten Sie auch KI-Chatbots für St. Galler Unternehmen an?",
        acceptedAnswer: {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        name: "Erstellen Sie auch Websites für die Textil- und Technologiebranche in St. Gallen?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Absolut! St. Gallen hat eine reiche Textilindustrie-Tradition und wächst als Technologie- und Innovationsstandort mit der Universität St. Gallen (HSG). Wir erstellen professionelle Websites für Unternehmen aller Branchen in der Ostschweiz.",
        },
      },
      {
        "@type": "Question",
        name: "Welche Technologien verwenden Sie für St. Galler Webprojekte?",
        acceptedAnswer: {
          "@type": "Answer",
...
const features = [
  {
    ...
    desc: "Wir kennen St. Gallen und die Ostschweiz — von der UNESCO-Altstadt über den Stiftsbezirk bis zum Rosenberg. Lokale SEO für maximale Sichtbarkeit bei St. Galler Kunden.",
    color: "#9945ff",
    icon: "map",
  },
  {
  ...
  },
  {
    ...
    desc: "Ab CHF 490 statt CHF 5'000+ bei lokalen St. Galler Agenturen. Kein Kompromiss bei Qualität — nur bei überhöhten Preisen.",
    color: "#14f195",
    icon: "price",
  },
  {
  ...
  },
  {
    ...
    desc: "Intelligente Chatbots und n8n-Workflows, die Kundenanfragen beantworten, Termine buchen und Leads qualifizieren — 24/7 für Ihr St. Galler Unternehmen.",
    color: "#9945ff",
    icon: "ai",
  },
  {
    title: "Mehrsprachig",
    desc: "Wir kommunizieren auf Deutsch, Englisch, Spanisch und Finnisch. Ideal für internationale Unternehmen und HSG-Startups in St. Gallen.",
    color: "#00d1ff",
    icon: "globe",
  },
];
...
const services = [
  {
    ...
    desc: "Moderne, mobiloptimierte Websites, die Ihr St. Galler Unternehmen perfekt repräsentieren und bei Google auf Seite 1 ranken.",
    price: "Ab CHF 490",
    color: "#00d1ff",
  },
  {
    title: "KI-Chatbots",
    desc: "Intelligente Chatbots, die Kundenanfragen automatisch beantworten, Termine buchen und Leads qualifizieren — rund um die Uhr in St. Gallen.",
    price: "Ab CHF 550",
    color: "#9945ff",
  },
  {
    title: "Automatisierung & Workflows",
    desc: "n8n-basierte Automatisierungen: E-Mail-Marketing, CRM-Integration, Social Media — massgeschneidert für St. Galler KMU und Startups.",
    price: "Ab CHF 350 + 90 CHF/Mt.",
    color: "#14f195",
  },
  {
    title: "SEO & Lokales Marketing",
    desc: "Suchmaschinenoptimierung speziell für St. Gallen und die Ostschweiz. Werden Sie gefunden, wenn Kunden nach Ihren Leistungen suchen.",
    price: "Inklusive",
    color: "#f971ff",
  },
];
...
const processSteps = [
  {
    step: "01",
    title: "Erstgespräch",
    desc: "Kostenlose Beratung via WhatsApp oder E-Mail. Wir analysieren Ihre Anforderungen und definieren den Projektumfang für Ihr St. Galler Unternehmen.",
    color: "#9945ff",
  },
  {
    step: "02",
...
const pricing = [
  {
    name: "Starter",
    price: "CHF 490",
    subtitle: "Perfekt für Einzelunternehmer in St. Gallen",
    features: [
      "One-Page-Website",
      "Responsives Design (Mobil + Desktop)",
      "SEO-Grundoptimierung für St. Gallen",
      "Kontaktformular",
  ...
  },
  {
    name: "Business",
    price: "CHF 990",
    subtitle: "Für wachsende KMU in St. Gallen",
    features: [
...
const faqs = [
  {
    q: "Was kostet eine professionelle Website in St. Gallen?",
    a: "Bei uns beginnen professionelle Websites ab CHF 490. Je nach Umfang und Funktionen liegen die Preise zwischen CHF 490 und CHF 1'490. Das ist deutlich günstiger als die meisten St. Galler Agenturen, die oft ab CHF 5'000 starten — ohne Qualitätsverlust.",
  },
  {
    q: "Wie lange dauert es, bis meine Website in St. Gallen online ist?",
  ...
  {
    q: "Erstellen Sie auch Websites für die Textilbranche und HSG-Startups?",
    a: "Absolut! St. Gallen ist berühmt für seine Textilindustrie und die Universität St. Gallen (HSG) — eine der besten Business Schools Europas. Wir erstellen professionelle Websites für traditionelle Unternehmen und innovative Startups gleichermassen.",
  },
  {
    q: "Betreuen Sie auch Unternehmen in der ganzen Ostschweiz?",
    a: "Ja, wir betreuen Unternehmen in St. Gallen-Stadt, Rorschach, Gossau, Herisau, Wil und der gesamten Ostschweiz. Remote-Zusammenarbeit ermöglicht schnelle und effiziente Projekte — bis zum Bodensee und darüber hinaus.",
  },
  {
    q: "Bieten Sie auch laufende Wartung und Support an?",
    a: "Ja. Nach dem Launch sind 30 Tage E-Mail-Support inklusive. Darüber hinaus bieten wir monatliche Wartungspakete an — inklusive Updates, Sicherheitschecks und Performance-Monitoring für Ihr St. Galler Unternehmen.",
  },
];
...
export default function WebdesignStGallenPage() {
  return (
    <>
      ...
      <title>
        Webdesign St. Gallen — Professionelle Websites für Ihr Unternehmen | El
        Fennir
      </title>
      <meta
        name="description"
        content="Professionelles Webdesign in St. Gallen. Moderne Websites, KI-Chatbots und Automatisierung für St. Galler Unternehmen. Ab CHF 490. Lieferung in 7 Tagen."
      />
      <meta
        name="keywords"
        content="webdesign st gallen, website erstellen st gallen, webdesign agentur st gallen, homepage erstellen st gallen, webseite st gallen, webentwicklung st gallen, ki chatbot st gallen, website st gallen kosten, professionelle website st gallen, webdesigner st gallen, seo st gallen, webdesign ostschweiz"
      />
      <meta
        property="og:title"
        content="Webdesign St. Gallen — Professionelle Websites & KI-Automatisierung"
      />
      <meta
        property="og:description"
        content="Moderne Websites, KI-Chatbots und Automatisierung für St. Galler Unternehmen. Ab CHF 490. Lieferung in 7 Tagen."
      />
      <meta property="og:type" content="website" />
      <meta
        property="og:url"
        content="https://elfennir.com/webdesign-st-gallen"
      />
      ...
      <meta
        ...
        content="Moderne Websites, KI-Chatbots und Automatisierung für St. Galler Unternehmen. Ab CHF 490."
      />
      <link
        rel="canonical"
      ...
      <main className="min-h-screen bg-[#08080f] text-slate-300">
        ...
        <section className="relative pt-32 pb-20 overflow-hidden">
          ...
          >
            ...
            >
              Webdesign St. Gallen &mdash; Tor zur Ostschweiz
            </motion.span>
            <motion.h1
              variants={fadeUp}
            ...
            >
              Moderne Webseiten, KI-Chatbots und Automatisierung f&uuml;r St. Galler
            ...
            >
              Ob HSG-Startup, Textilunternehmen in der Altstadt oder Gastro
              am Stiftsbezirk &mdash; wir liefern Ihre Website in 7 Tagen. Ab CHF 490,
              inklusive SEO.
            </motion.p>
            <motion.div
              variants={fadeUp}
            ...
            >
              <a
                href="https://wa.me/358466109064?text=Hallo!%20Ich%20brauche%20eine%20professionelle%20Website%20f%C3%BCr%20mein%20Unternehmen%20in%20St.%20Gallen."
          ...
          <div className="max-w-5xl mx-auto px-6">
            ...
            >
              ...
              >
                ...
                Transformation &mdash; alles aus einer Hand f&uuml;r Ihr St. Galler
                Unternehmen.
              </motion.p>
          ...
          <div className="max-w-5xl mx-auto px-6">
            ...
            >
              ...
              >
                ...
                St. Galler Unternehmen &mdash; zu einem Bruchteil der &uuml;blichen
                Agenturpreise.
              </motion.p>
              <div className="grid md:grid-cols-3 gap-6">
                {pricing.map((plan, i) => (
                  ...
                  >
                    ...
                    <a
                      href={`https://wa.me/358466109064?text=Hallo!%20Ich%20interessiere%20mich%20f%C3%BCr%20das%20${encodeURIComponent(plan.name)}-Paket%20f%C3%BCr%20mein%20Unternehmen%20in%20St.%20Gallen.`}
          ...
          <div className="max-w-3xl mx-auto px-6 text-center">
            ...
            >
              ...
              >
                ...
                massgeschneidertes Angebot f&uuml;r Ihr St. Galler Unternehmen &mdash; innerhalb von 24 Stunden.
              </motion.p>
              <motion.div
                variants={fadeUp}
                transition={{ duration: 0.5, delay: 0.2 }}
              ...
              >
                <a
                  href="https://wa.me/358466109064?text=Hallo!%20Ich%20m%C3%B6chte%20eine%20professionelle%20Website%20f%C3%BCr%20mein%20Unternehmen%20in%20St.%20Gallen."
                  className="sol-btn inline-flex items-center justify-center gap-2 px-8 py-4 rounded-xl text-white font-semibold text-lg transition-all"
                >
                  <svg
                    className="w-5 h-5"
                ...
                <a
                  href="mailto:yassin@elfennir.com?subject=Webdesign-Anfrage%20St.%20Gallen"
                  className="inline-flex items-center justify-center gap-2 px-8 py-4 rounded-xl border border-white/10 text-white font-semibold text-lg hover:border-[#9945ff]/40 hover:bg-white/[0.03] transition-all"
                >
                  E-Mail senden
                </a>
